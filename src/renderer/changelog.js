export const CHANGELOG = [
  {
    ...
    text: '???',
    list: [
      'Наконец-то: полностью рабочие механизмы приглашений, регистрации (в т.ч. через соцсети), веб-логина, присоединения к воркспейсу.',
      'Обновлённый лендинг и прочие веб-страницы.',
      'Если воркспейс подключён к слаку, у собеседника подключён слак, и он оффлайн, то можно отправить ему инвайт через слак.',
      'Названия каналов теперь только с маленькой буквы.',
      'В MacOS оявился онбординг с запросом доступов микрофона, камеры и скриншаринга.',
      'И на эторт раз ОЧЕНЬ много мелких фиксов и улучшений 🥝',
    ],
  },
  {
    version: 'v1.2.2',
