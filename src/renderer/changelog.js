export const CHANGELOG = [
  {
    version: 'v1.1.12',
    text: `• Добавили отдельный интерфейс приглашения в канал: чтобы вызвать кого-то на разговор, выбирайте сразу нескольких людей из списка. В этом же разделе теперь прячется управление временной ссылкой для приглашения гостей через браузер.
  ...
  {
    version: 'v1.1.11',
    text: `• Приложение перешло на свежие версии Electron и Chromium! Большие изменения под капотом, улучшение безопасности и производительности, плюс открылась возможность некоторых фич в следующих обновлениях
  ...
  {
    version: 'v1.1.9',
    text: `• Множественные улучшения звонков, аудио- видеосвязи
  ...
  {
    version: 'v1.1.8',
    text: `• Улучшили качество связи: пропало большинство прерываний! Если прерывания всё ещё случаются, не забывайте нажимать на "плохо слышно"
